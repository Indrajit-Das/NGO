...
class PhotoGalleryController extends Controller
{
    ...
    {
        //
        $photoGallery = PhotoGallery::latest()->paginate(10);
        return view('backend.admin.pages.photo_gallery.photoGalleryManage',compact('photoGallery'));
    }
    ...
    {
        //
        return view('backend.admin.pages.photo_gallery.photoGalleryEntry');
    }
    ...
    public function edit($id)
    {
        //
        $photoGallery = PhotoGallery::find($id);
        return view('backend.admin.pages.photo_gallery.photoGalleryEdit',compact('photoGallery'));
    }
