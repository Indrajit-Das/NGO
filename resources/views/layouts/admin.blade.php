...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/backend/dashboard/main.css') }}">
    ...
    <body class="font-sans antialiased">
        ...
        <div class="min-h-screen bg-gray-100">
            ...
            <nav x-data="{ open: false }" class=" border-b border-gray-100" style="background-color: #009688;">
        ...
        <div class="flex justify-between h-16" >
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('admin/dashboard') }}" :active="request()->routeIs('admin/dashboard')" style="color:white">
                        {{ __('Dashboard') }}
                    </x-jet-nav-link>
                </div>
            </div>
