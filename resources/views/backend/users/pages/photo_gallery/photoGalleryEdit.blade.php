...
@section('title',Auth::user()->name.'-photo-gallery-edit')
...
@section('content')
    <div class="col-sm-8 ml-auto mr-auto">
        ...
        <div class="card-header">
           <div class="row">
               <div class="col-sm-4" style="margin-top:8px;">
                <a href="{{ URL::to('user/photo-gallery') }}"><i class="fa fa-reply fa-lg" aria-hidden="true"></i></a>
            </div>
            <div class="col-sm-8">
        ...
        <div class="card-body">
            <form action="{{ URL::to('user/photo-gallery/'. $photoGallery->id) }}" method="post"  enctype="multipart/form-data">
                @csrf
                @method('PUT')
