...
@section('title','slider-image-entry')
...
<div class="col-sm-8 ml-auto mr-auto">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ URL::to('/slider-image') }}" method="post"  enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    ...
                    <input class="form-control formcontrol-image-input mt-2" type="file" id="photo" name="photo" onchange="preview_image(event)">
                </div>
